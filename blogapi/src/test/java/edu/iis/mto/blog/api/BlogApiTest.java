...
public class BlogApiTest {
    ...
    @Test
    public void httpCode409GetExceptionDataIntegrityViolation() throws Exception {
        UserRequest userRequest = new UserRequest("Agnieszka", "Dabrowska", "dagnieszka@wp.pl");
        when(blogService.createUser(userRequest)).thenThrow(new DataIntegrityViolationException("Test"));
        String json = writeJson(userRequest);
        mvc.perform(post("/blog/user").contentType(MediaType.APPLICATION_JSON_UTF8)
