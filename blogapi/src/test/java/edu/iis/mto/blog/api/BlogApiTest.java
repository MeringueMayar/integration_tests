...
public class BlogApiTest {
    ...
    @Test
    public void fetchDataOfNonExistUserShouldResponseWithStatus404() throws Exception {
    	Mockito.when(finder.getUserData(new Long(1))).thenThrow(EntityNotFoundException.class);
