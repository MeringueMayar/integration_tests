...
public class BlogApiTest {
    ...
    @Test
    public void throwingDataIntegrityViolationExceptionShouldCauseConflictResponse() throws Exception {
        UserRequest user = new UserRequest();
    ...
    @Test
    public void getNonexistentBlogUserShouldResponseWithNotFoundStatus() throws Exception {
        Long userId = 1L;
