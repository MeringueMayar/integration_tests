...
public class BlogApiTest {
    ...
    @Test
    public void throwingDataIntegrityViolationExceptionShouldGenerateHTTPResponseError409() throws Exception {
        UserRequest user = new UserRequest();
        user.setEmail("john@domain.com");
        user.setFirstName("John");
        user.setLastName("Steward");
    ...
    @Test
    public void gettingDataOfNotExistingUserShouldReturnHTTPResponseError404() throws Exception {
        Long id = 5432L;
